...
> Reste connu différé (Phase 3) : historique /objectifs (clôturés consultables), unification des 3 rendus de carte, densité MeetingView, synthèses IA lisant le journal, PDF monthly objectifs clôturés, badge échéance dépassée, garde UPDATE-réactivation du trigger ; cleanup : dédup coquille dialogs/mapping, labels FR en dur dans `AppSidebar.weeklyLabelOverrides` (pré-existant).
...
> Dernière mise à jour : 2026-07-03 (Phase 2 live).
